        ...
        lodProfiles: {
            ...
            tactical: {
                ...
                tacticalStyleOverrides: {
                    ...
                    warmCoolStrength: 0.24,
                    minLighting: 0.40,
                    // tactical 专属接缝抑制：仅收敛导数突变，不影响其他档位渲染链路。
                    seamSuppressStrength: 0.52,
                    normalDetailGain: 1.34,
                    edgeEnhanceGain: 1.32,
                    skirtSuppressStrength: 0.72,
                    seamFlattenStrength: 0.20,
                    seamLightingSuppress: 0.26,
                    plainBlendGain: 0.03,
                    rockDetailGain: 2.35,
                    seamBandStrength: 0.06,
                    seamMatteStrength: 0.02
                }
            }
