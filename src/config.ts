        ...
        lodProfiles: {
            ...
            tactical: {
                ...
                tacticalStyleOverrides: {
                    enableRelief: true,
                    enableContour: false,
                    enableMacroGrid: true,
                    enableMicroGrid: false,
                    contourInterval: 56.0,
                    contourThickness: 2.6,
                    macroGridDensity: 20.0,
                    macroGridWidth: 0.11,
                    ...
                    colorRidge: '#c9aa62',
                    colorContour: '#2b1d12',
                    colorMacroGrid: '#ffe89a',
                    colorMicroGrid: '#38dcff',
                    toneGamma: 0.88,
                    toneShadowFloor: 0.50,
                    atmosphereHazeColor: '#000000',
                    atmosphereFarStart: 22000.0,
                    atmosphereFarEnd: 100000.0,
                    atmosphereStrength: 0.12,
                    minLighting: 0.26,
                    redFlagSlopeStart: 0.16,
                    redFlagSlopeEnd: 0.84,
                    redFlagHardBand: 0.40,
                    redFlagGridMix: 0.44,
                    redFlagGridEmissive: 1.18
                }
            }
